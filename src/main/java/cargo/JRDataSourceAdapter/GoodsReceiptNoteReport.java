...
public class GoodsReceiptNoteReport{
	...
	public GoodsReceiptNoteReport(String id, String documentNo,
	...
	public static final RowMapper<GoodsReceiptNoteReport> ROW_MAPPER = new RowMapper<GoodsReceiptNoteReport>(){

		@Override
		public GoodsReceiptNoteReport mapRow(ResultSet rs, int rowNum) throws SQLException {	//mapper when select
			
			GoodsReceiptNoteReport t= new GoodsReceiptNoteReport(
					rs.getString("id"),
